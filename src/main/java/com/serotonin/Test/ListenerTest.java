...
public class ListenerTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final ModbusSlaveSet listener = modbusFactory.createTcpSlave(false);//创建tcp从站,端口在程序中写死,为502
        System.out.println(listener.getMaxReadBitCount());
...
//        listener.addProcessImage(getModscanProcessImage(9));
        ...
        //当监听会用当前线程去运行,所以,当没有异常抛出,这个回掉方法将不会返回,所以我们在一个独立的线程去启动监听,我们可以用这个线程去修改值
...
//            System.out.println(listener.getProcessImages());
        }
    }
