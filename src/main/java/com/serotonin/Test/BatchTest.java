...
public class BatchTest {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            int slaveId = 5;
//            batchRead.addLocator("00011 sb false", BaseLocator.coilStatus(slaveId, 1));
//            batchRead.addLocator("00012 sb false", BaseLocator.coilStatus(slaveId, 2));
//            batchRead.addLocator("00013 sb true", BaseLocator.coilStatus(slaveId, 3));
//            batchRead.addLocator("00014 sb true", BaseLocator.coilStatus(slaveId, 4));
//
//            batchRead.addLocator("10011 sb false", BaseLocator.inputStatus(slaveId, 1));
//            batchRead.addLocator("10012 sb false", BaseLocator.inputStatus(slaveId, 2));
//            batchRead.addLocator("10013 sb true", BaseLocator.inputStatus(slaveId, 3));
//            batchRead.addLocator("10014 sb false", BaseLocator.inputStatus(slaveId, 4));
//
            batchRead.addLocator("40016-0 sb true", BaseLocator.holdingRegisterBit(slaveId, 1, 0));
            batchRead.addLocator("40016-1 sb false", BaseLocator.holdingRegisterBit(slaveId, 2, 1));
            batchRead.addLocator("40016-2 sb false", BaseLocator.holdingRegisterBit(slaveId, 3, 2));
            batchRead.addLocator("40016-3 sb true", BaseLocator.holdingRegisterBit(slaveId, 4, 3));
            batchRead.addLocator("40016-4 sb false", BaseLocator.holdingRegisterBit(slaveId, 5, 4));
            batchRead.addLocator("40016-5 sb false", BaseLocator.holdingRegisterBit(slaveId, 6, 5));
            batchRead.addLocator("40016-6 sb false", BaseLocator.holdingRegisterBit(slaveId, 7, 6));
            batchRead.addLocator("40016-7 sb false", BaseLocator.holdingRegisterBit(slaveId, 8, 6));
            batchRead.addLocator("40016-8 sb false", BaseLocator.holdingRegisterBit(slaveId, 9, 6));
