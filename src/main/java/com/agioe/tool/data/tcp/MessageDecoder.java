...
/**
 * 改写了netty自带的LengthFieldBasedFrameDecoder
 *
 * <p>
 ...
 * <p>
 * {@link } has many configuration parameters so
...
public class MessageDecoder extends ByteToMessageDecoder {
    ...
    /**
     * 修改了frame长度算法，由lengthFieldEndOffset替换为lengthFieldOffset
     * <p>
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        //修改了frame长度算法，由lengthFieldEndOffset替换为lengthFieldOffset
        frameLength += lengthAdjustment + lengthFieldOffset;
