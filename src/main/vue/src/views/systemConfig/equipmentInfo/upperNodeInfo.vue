  ...
  <div>
    ...
    <div class="tagTip">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item class="title">上层节点信息配置</el-breadcrumb-item>
      </el-breadcrumb>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="parentNodeCode"
                       label="节点编号"
                       width="180">
      </el-table-column>
    ...
    <el-dialog title="新增"
      ...
      <el-form :model="formAdd"
        ...
        <el-form-item label="节点编号"
                      prop="parentNodeCode">
          <el-input v-model="formAdd.parentNodeCode"
                    placeholder="请输入类型编码"></el-input>
        </el-form-item>

        <el-form-item label="节点名称"
                      prop="parentNodeName">
          <el-input v-model="formAdd.parentNodeName"
    ...
    <el-dialog title="编辑"
      ...
      <el-form :model="formEdit"
        ...
        <el-form-item label="节点编号"
                      prop="parentNodeCode">
          <el-input v-model="formEdit.parentNodeCode"
                    disabled
...
<script>
import * as AJAX from '@/api/systemConfig/equipmentInfo/upperNodeInfo.js'
